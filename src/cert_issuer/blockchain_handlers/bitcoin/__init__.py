...
from src.cert_issuer.blockchain_handlers.bitcoin.connectors import BitcoinServiceProviderConnector, MockServiceProviderConnector
from src.cert_issuer.blockchain_handlers.bitcoin.signer import BitcoinSigner
from src.cert_issuer.blockchain_handlers.bitcoin.transaction_handlers import BitcoinTransactionHandler
from src.cert_issuer.certificate_handlers import CertificateBatchHandler, CertificateV2Handler, CertificateBatchWebHandler, CertificateWebV2Handler
from src.cert_issuer.merkle_tree_generator import MerkleTreeGenerator
from src.cert_issuer.models import MockTransactionHandler
from src.cert_issuer.signer import FileSecretManager
...
def initialize_signer(app_config):
    ...
    secret_manager = FileSecretManager(signer=signer, secret_key=app_config["secret_key"],
